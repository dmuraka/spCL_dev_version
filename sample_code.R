...
library(sf)
library(devtools)
source_url("https://raw.githubusercontent.com/dmuraka/spCL_dev_version/main/cf_lm_functions.R")
...
mod_hv  <- cf_lm_hv(y=y, x=x, coords=coords, kernel="exp",
...
#### Coase-to-Fine spatial modeling (CFSM)
mod     <- cf_lm(y=y, x=x, coords=coords, x0=x0, coords0=coords0, mod_hv=mod_hv)
...
mod_sim <- cf_lm_sim(mod, nsim=200)
